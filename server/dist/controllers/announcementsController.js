...
exports.getAnnouncements = (0, catchAsync_1.catchAsync)(async (req, res, next) => {
    ...
    const announcements = await AnnouncementModel_1.default.find().populate("creator", "name");
    res.status(200).json({
        status: "success",
        data: {
            announcements,
...
exports.updateAnnouncementById = (0, catchAsync_1.catchAsync)(async (req, res, next) => {
    var _a;
    if (((_a = req.user) === null || _a === void 0 ? void 0 : _a.role) !== "teacher") {
        return next(new appError_1.AppError("Only teachers can update announcements", 403));
    }
    const { name, course, announcementText } = req.body;
    const AnnouncementId = req.params.AnnouncementId;
    const existingannouncement = await AnnouncementModel_1.default.findById(AnnouncementId).populate("creator", "name");
...
exports.deleteAnnouncementById = (0, catchAsync_1.catchAsync)(async (req, res, next) => {
    var _a;
    if (((_a = req.user) === null || _a === void 0 ? void 0 : _a.role) !== "teacher") {
        return next(new appError_1.AppError("Only teachers can delete announcements", 403));
    }
    const AnnouncementId = req.params.AnnouncementId;
